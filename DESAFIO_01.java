    ...
    public static void main(String[] args) {
        ...
        if (idadeNinja01 < 15) ;
        {
            if (nivelDeDificuldadeNinja01 == 'D' || nivelDeDificuldadeNinja01 == 'C') {
                ...
                System.out.println("Pré requisitos: Não, idade : " + idadeNinja01 + " e Dificuldade: " + nivelDeDificuldadeNinja01);
            }
        }
            ...
            if (idadeNinja02 < 15) ;
            {
                if (nivelDeDificuldadeNinja02 == 'D' || nivelDeDificuldadeNinja02 == 'C') {
                    ...
                    System.out.println("Pré requisitos: Não, idade : " + idadeNinja02 + " e Dificuldade: " + nivelDeDificuldadeNinja02);
                }
            }
        ...
        System.out.println("------------------------------------------------------");
            ...
            if (idadeNinja03 < 15) ;
            {
                if (nivelDeDificuldadeNinja03 == 'D' || nivelDeDificuldadeNinja03 == 'C') {
                    ...
                    System.out.println("Pré requisitos: Não, idade : " + idadeNinja03 + " e Dificuldade: " + nivelDeDificuldadeNinja03);
                }
            }
            System.out.println("------------------------------------------------------");
